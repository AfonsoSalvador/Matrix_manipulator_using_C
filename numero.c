...
/*--------------------------------------------------------------------*
*          IMPLEMENTAÇÃO DAS FUNÇÕES VIRTUAIS DO Numero_t             *
*---------------------------------------------------------------------*/
...
static inline Numero_pt Num_atribui_ (Numero_t const * const me, Numero_t * const outro){
	assert (0); 
	printf ("%p %p",(void *)me, (void *)outro);
	return (Numero_pt) NULL;  
}

static inline Numero_pt Num_soma_ (Numero_t const * const me, Numero_t const * const outro, Numero_t  * const  res){
	assert (0);
	printf ("%p %p %p",(void *)me, (void *)outro, (void *)res);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_subt_ (Numero_t const * const me, Numero_t const * const outro, Numero_t * const res){
	assert (0);
	printf ("%p %p %p",(void *)me, (void *)outro, (void *)res);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_mult_ (Numero_t const * const me, Numero_t const * const outro, Numero_t * const res){
	assert (0);
	printf ("%p %p %p",(void *)me, (void *)outro, (void *)res);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_divd_ (Numero_t const * const me, Numero_t const * const outro, Numero_t * const res){
	assert (0);
	printf ("%p %p %p",(void *)me, (void *)outro, (void *)res);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_ac_soma_ (Numero_t * const me, Numero_t const * const outro){
	assert (0);
	printf ("%p %p",(void *)me, (void *)outro);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_ac_subt_ (Numero_t * const me, Numero_t const * const outro){
	assert (0);
	printf ("%p %p",(void *)me, (void *)outro);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_ac_mult_ (Numero_t  * const  me,Numero_t const * const outro){
	assert (0);
	printf ("%p %p",(void *)me, (void *)outro);
	return (Numero_pt) NULL;
}

static inline Numero_pt Num_ac_divd_ (Numero_t* const me, Numero_t const * const outro){
	assert (0);
	printf ("%p %p",(void *)me, (void *)outro);
	return (Numero_pt) NULL;
}
...
static inline int Num_compara_ (Numero_t const * const me, Numero_t const * const outro){
	assert (0);
	printf ("%p %p",(void *)me, (void *)outro);
	return (0);
}
